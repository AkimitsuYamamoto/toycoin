...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s toycoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  toycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded toycoin transaction") + "\n" +
              "  toycoin-tx [options] -create [commands]   " + _("Create hex-encoded toycoin transaction") + "\n" +
              "\n";
