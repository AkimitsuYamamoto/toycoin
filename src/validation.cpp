...
#if defined(NDEBUG)
# error "toycoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "toycoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s TOYC additional fees, %d delta bytes\n",
