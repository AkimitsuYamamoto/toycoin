...
const char * const BITCOIN_CONF_FILENAME = "toycoin.conf";
const char * const BITCOIN_PID_FILENAME = "toycoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "toycoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/toycoin";
#else
    // Unix
    return pathRet / ".toycoin";
#endif
#endif
}
